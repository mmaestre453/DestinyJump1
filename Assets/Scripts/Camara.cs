...
public class Camara : MonoBehaviour
{
    ...
    void Update()
    {
        //obtener posicion en x inicial
        iniCamPosFrame = transform.position.x;
        transform.position = new Vector3(PlayerDestiniy.obj.transform.position.x, transform.position.y, transform.position.z);
    }

    void LateUpdate(){
        //obtener posicion despues de update
